...
final diaryByDateProvider =
    FutureProvider.autoDispose.family<DiaryEntry?, DateTime>((ref, date) {
...
final saveDiaryProvider =
    NotifierProvider<SaveDiaryNotifier, SaveDiaryState>(SaveDiaryNotifier.new);
